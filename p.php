...
echo '<style type="text/css">body{}#v720{position:fixed;width:100%;height:100%;z-index:100;top:0px;left:0px}</style><video id="v720" controls> <source src='.$v720p.' type="video/mp4"></video>';
